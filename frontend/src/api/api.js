...
export const deleteMovieGenre = (movieId, genreId) => api.delete(`/relations/moviegenres/${movieId}/${genreId}`); 

export const addMovieActor = (data) => api.post('/relations/movieactors', data);
export const deleteMovieActor = (movieId, actorId) => api.delete(`/relations/movieactors/${movieId}/${actorId}`); 
