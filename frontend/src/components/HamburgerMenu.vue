...
<template>
    <div id="Menu">
        ...
        <button @click="toggleMenu" id="toggleMenuBtn" class="mobile-only">
            Menu
        </button>
        ...
        <div v-if="isMenuOpen" class="OpenMenu mobile-only">
            <ul>
                <li>
                    <router-link to="/movie" @click="closeMenu()"
                        >All Movies</router-link
                    >
                </li>
                <li>
                    <router-link to="/top-movies" @click="closeMenu()"
                        >Top Movies</router-link
                    >
                </li>
                <li>
                    <router-link to="/popular-movies" @click="closeMenu()"
